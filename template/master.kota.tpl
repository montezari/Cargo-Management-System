        ...
        [onload_1; when [var.mode;noerr]==0; block=div]
            ...
            <div class="box-body table-responsive">
                ...
                <input name='fkey' id='fkey' type='hidden' size=/>
                    <thead>
                        <tr>
                            <th>[var.LABEL.KODE_KOTA;noerr;]</th>
                            <th>[var.LABEL.NAMA_KOTA;noerr;]</th>
                            <th>[var.LABEL.PROPINSI;noerr;]</th>
                            <th>[var.LABEL.NAMA_NEGARA;noerr;]</th>
                            <th colspan="3">&nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>[grid_blk.ckdkota;noerr;block=tr]</td>
                            <td>[grid_blk.vnmkota;noerr;block=tr]</td>
                            <td>[grid_blk.vnmprovisi;noerr;block=tr]</td>
                            <td>[grid_blk.vnmnegara;noerr;block=tr]</td>
                            <td width="25" align="center">[var.button.E;if [var.button.E;noerr]=='valid';then <a href="#" class="back" onClick="window.location = '?m=[var.~moduleid;noerr]&mode=form&key=[grid_blk.ckdkota;noerr]'"><span class="fa fa-eject"></span></a>;else <span class="fa fa-eject"></span>]</td>
                            <td width="25" align="center">[var.button.D;if [var.button.D;noerr]=='valid';then <a href="#" class="back" onClick="ConfirmDelete('[grid_blk.ckdkota;noerr]')"><span class="fa fa-trash-o"></span></a>;else <span class="fa fa-trash-o"></span>]</td>
                        </tr>
                        <tr>
                          <td colspan="4">&nbsp;</td>
    ...
    [onload_1; when [var.mode;noerr]==1; block=div]
        <div class="portlet box">
            <div class="portlet-body form">
                ...
                <input name='fkey' id='fkey' type='hidden' value='[grid_blk.ckdkota;noerr;]' size=/>
                    <div class="form-body">
                        <div class="form-group">
                            <label>[var.LABEL.NAMA_NEGARA;noerr;]</label>
                        ...
                        <div class="form-group">
                            <label class="control-label">[var.LABEL.KODE_KOTA;noerr;]</label>
                            <input type="text" name="kdkota" id="kdkota" class="form-control" value="[grid_blk.ckdkota;noerr;]" [onshow; if [grid_blk.kdkota;noerr;]!='';then 'disabled';else '']>
                        </div>
                        <div class="form-group">
                            <label class="control-label">[var.LABEL.NAMA_KOTA;noerr;]</label>
                            <input type="text" name="nmkota" id="nmkota" class="form-control" value="[grid_blk.vnmkota;noerr;]">
                        </div>
                        <div class="form-group">
                            <label class="control-label">[var.LABEL.PROPINSI;noerr;]</label>
                            <input type="text" name="nmprop" id="nmprop" class="form-control" value="[grid_blk.vnmkota;noerr;]">
                        </div>
                    </div>
