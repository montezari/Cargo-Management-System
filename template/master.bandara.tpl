        ...
        [onload_1; when [var.mode;noerr]==0; block=div]
            ...
            <div class="box-body table-responsive">
                ...
                <input name='fkey' id='fkey' type='hidden' size=/>
                    <thead>
                        <tr>
                            <th>[var.LABEL.KODE_BANDARA;noerr;]</th>
                            <th>[var.LABEL.NAMA_BANDARA;noerr;]</th>
                    ...
                    <tbody>
                        <tr>
                            <td>[grid_blk.ckdbandara;noerr;block=tr]</td>
                            <td>[grid_blk.vnmbandara;noerr;block=tr]</td>
                            <td>[grid_blk.vnmkota;noerr;block=tr]</td>
                            <td>[grid_blk.vnmnegara;noerr;block=tr]</td>
                            <td width="25" align="center">[var.button.E;if [var.button.E;noerr]=='valid';then <a href="#" class="back" onClick="window.location = '?m=[var.~moduleid;noerr]&mode=form&key=[grid_blk.ckdbandara;noerr]'"><span class="fa fa-eject"></span></a>;else <span class="fa fa-eject"></span>]</td>
                            <td width="25" align="center">[var.button.D;if [var.button.D;noerr]=='valid';then <a href="#" class="back" onClick="ConfirmDelete('[grid_blk.ckdbandara;noerr]')"><span class="fa fa-trash-o"></span></a>;else <span class="fa fa-trash-o"></span>]</td>
                        </tr>
                        <tr>
                          <td colspan="4">&nbsp;</td>
    ...
    [onload_1; when [var.mode;noerr]==1; block=div]
        <div class="portlet box">
            <div class="portlet-body form">
                ...
                <input name='fkey' id='fkey' type='hidden' value='[grid_blk.ckdbandara;noerr;]' size=/>
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label">[var.LABEL.KODE_BANDARA;noerr;]</label>
                            <input type="text" name="kdbandara" id="kdbandara" class="form-control" value="[grid_blk.ckdbandara;noerr;]" [onshow; if [grid_blk.ckdbandara;noerr;]!='';then 'disabled';else '']>
                        </div>
                        <div class="form-group">
                            <label class="control-label">[var.LABEL.NAMA_BANDARA;noerr;]</label>
                            <input type="text" name="nmbandara" id="nmbandara" class="form-control" value="[grid_blk.vnmbandara;noerr;]">
                        </div>
                        <div class="form-group">
