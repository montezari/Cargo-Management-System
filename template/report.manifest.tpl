                ...
                <input name="rec" id="rec" type="hidden" value="[var.bykdata;noerr;]" size=/>
                   ...
                   <div style="display:none;" id="panel" class="progress progress-striped active">
                    ...
                    <div class="nobg fluid">
                        ...
                        <button type="button" id="FormCetakBarcode" name="FormCetakBarcode" onclick="print_qrbarcode();" value="CetakBarcode" class="btn default hidden-print">[var.LABEL.PRINT_BARCODE;noerr;]</button>
