        ...
        [onload_1; when [var.mode;noerr]==0; block=div]
            ...
            <div class="box-body table-responsive">
                ...
                <input name='fkey' id='fkey' type='hidden' size=/>
                    <thead>
                        <tr>
                            <th>[var.LABEL.KODE_NEGARA;noerr;]</th>
                    ...
                    <tbody>
                        <tr>
                            <td>[grid_blk.ckdnegara;noerr;block=tr]</td>
                            <td>[grid_blk.vnmnegara;noerr;block=tr]</td>
                            <td width="25" align="center">[var.button.E;if [var.button.E;noerr]=='valid';then <a href="#" class="back" onClick="window.location = '?m=[var.~moduleid;noerr]&mode=form&key=[grid_blk.ckdnegara;noerr]'"><span class="fa fa-eject"></span></a>;else <span class="fa fa-eject"></span>]</td>
                            <td width="25" align="center">[var.button.D;if [var.button.D;noerr]=='valid';then <a href="#" class="back" onClick="ConfirmDelete('[grid_blk.ckdnegara;noerr]')"><span class="fa fa-trash-o"></span></a>;else <span class="fa fa-trash-o"></span>]</td>
                        </tr>
                        <tr>
                          <td colspan="2">&nbsp;</td>
    ...
    [onload_1; when [var.mode;noerr]==1; block=div]
        <div class="portlet box">
            <div class="portlet-body form">
                ...
                <input name='fkey' id='fkey' type='hidden' value='[grid_blk.ckdnegara;noerr;]' size=/>
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label">[var.LABEL.KODE_NEGARA;noerr;]</label>
                            <input type="text" name="kdnegara" id="kdnegara" class="form-control" value="[grid_blk.ckdnegara;noerr;]" [onshow; if [grid_blk.ckdnegara;noerr;]!='';then 'disabled';else '']>
                        </div>
                        <div class="form-group">
                            <label class="control-label">[var.LABEL.NAMA_NEGARA;noerr;]</label>
                            <input type="text" name="nmnegara" id="nmnegara" class="form-control" value="[grid_blk.vnmnegara;noerr;]">
                        </div>
                    </div>
