function docetak(){
	var options = { mode : "iframe", popClose : close, extraCss : "", retainAttr : "class,id,style,on", extraHead : "<h3>Laporan Saldo Agent</h3>" };
...
function doexpexcel(){ 
	...
	var _url = "excel.php?export=xlsx&id=report.saldoagent&kdagent="+kdagent+"&kdcurr="+kdcurr+"&cmbbln="+cmbbln+"&cmbtahun="+cmbtahun;
	$('#panel').css('display', 'block');
	progbar(_url);
