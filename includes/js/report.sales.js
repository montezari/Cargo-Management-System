function docetak(){
	var options = { mode : "iframe", popClose : close, extraCss : "", retainAttr : "class,id,style,on", extraHead : "<h3>Laporan Rekapitulasi Penjualan Detail</h3>" };
...
function doexpexcel(){ 
	...
	var _url = "excel.php?export=xlsx&id=report.sales&kdcurr="+kdcurr+"&tglawal="+tglawal+"&tglakhir="+tglakhir;
	$('#panel').css('display', 'block');
	progbar(_url);
